...
if (bootstrap_phase == "after_item_types_defined") then
	register_on_client_click("quarterblockdynamicitem", run)
	register_on_client_click("quarterblockgreyitem", run)
	register_on_client_click("quarterblockbrowndarkitem", run)
	register_on_client_click("quarterblockbrownlightitem", run)
	return
end
