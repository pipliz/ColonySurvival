...
namespace Pipliz.APIProvider.Jobs
{
	public class FueledCraftingJobBase : BlockJobBase, IRecipeLimitsProvider
	{
		...
		public virtual IList<RecipeFueled> GetPossibleRecipes { get { return RecipeStorage.GetPlayerStorage(owner).GetAllAvailableRecipes<RecipeFueled>(NPCTypeKey); } }
		...
		public override void OnNPCDoJob (ref NPCBase.NPCState state)
		{
			...
			if (selectedRecipe != null) {
				...
				var recipeMatch = Recipe.MatchRecipe<RecipeFueled, IList<RecipeFueled>>(GetPossibleRecipes, usedNPC.Colony.UsedStockpile);
		...
		{
			return Recipe.LoadRecipesFueled(GetRecipeLocation());
		}
